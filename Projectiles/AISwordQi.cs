...
public class AISwordQi : ModProjectile
{
    ...
    public override void AI()
    {
        ...
        for (var i = 0; i < 3; i++)
        {
            ...
            var dust = Dust.NewDustDirect(dustPos, 0, 0, DustID.PurpleTorch, 0f, 0f, 100, Color.Purple, 1.5f);
        ...
        if (Main.rand.NextBool(3))
        {
            var electricDust = Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height,
                DustID.Electric, 0f, 0f, 100, Color.Violet);
        ...
        if (Main.rand.NextBool(2))
        {
            ...
            var trailDust =
                Dust.NewDustDirect(trailPos, 4, 4, DustID.Shadowflame, 0f, 0f, 150, Color.MediumPurple, 0.8f);
