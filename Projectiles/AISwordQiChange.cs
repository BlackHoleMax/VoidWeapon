...
namespace VoidWeapon.Projectiles
{
    public class AISwordQiChange : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            // 弹幕大小随时间逐渐变小
            float timeProgress = (float)(180 - Projectile.timeLeft) / 180f; // 0到1的进度
            ...
            if (targetNPC != null)
            {
                ...
                {
                    Dust targetDust = Dust.NewDustDirect(Projectile.Center, 0, 0, DustID.Electric, 0f, 0f, 100, Color.Violet, 1.2f * Projectile.scale);
            ...
            for (int i = 0; i < 3; i++)
            {
                ...
                Dust dust = Dust.NewDustDirect(dustPos, 0, 0, DustID.PurpleTorch, 0f, 0f, 100, Color.Purple, 1.5f * Projectile.scale);
            ...
            if (Main.rand.NextBool(2))
            {
                ...
                Dust trailDust = Dust.NewDustDirect(trailPos, 4, 4, DustID.Shadowflame, 0f, 0f, 150, Color.MediumPurple, 0.8f * Projectile.scale);
